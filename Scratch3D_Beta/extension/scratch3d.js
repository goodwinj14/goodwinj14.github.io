  ...
  function sModal(templateId, data) {
    ...
    $("img", $modal).click(function(e){
        ...
        if(buttonID=='edit_mode'){
            ...
            document.getElementById("container").style.width = "73%";
