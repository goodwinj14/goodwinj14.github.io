    ...
    if (!$element.length) {
        var templateContent = "";
            ...
            console.log("templateContent2: ", document.getElementById(templateId).html);
                templateContent = "<dialog class='extension-warning with-icon'><section><div id='container' style='height: 200px; width: 200px; background-color: #ccffcc;'></div>"+htmlCode+"</section></dialog>";
...
function CreateFromTemplate(elementId, templateId, elementType, appendTo, wrapper, data) {
    ...
    if (!$element.length) {
        ...
        if (typeof(templateId) != "string") {
            ...
            console.log("HTMLCODE: ", htmlCode.html);
            templateContent += $(document.getElementById(templateId)).html();
