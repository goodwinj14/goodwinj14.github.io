    ...
    if (!$element.length) {
        var templateContent = "";
            ...
            templateContent += $(document.getElementById(templateId)).html();
                templateContent = "<dialog class='modal-inner' style='height: 400px; width: 500px; background-color: #ccffcc;'><section id='Holder' style='background-color: #cbffcc;'><div id='container' style='height: 400px; width: 500px; background-color: #ccffcc;'></div></section></dialog>";
