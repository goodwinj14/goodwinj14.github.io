(function(ext) {
	...
	var liveURL = "http://goodwinj14.github.io/ThreeJS/server/scratch3d.html";
  ...
  ext.addLight = function(lightType, color, Intensity, locX, locY, locZ){
    ...
    var descriptor = {
      ...
      ['', "Move %s %m.Move %n Steps" , 'moveShape', "Variable", "Left", 1],
			...
			['', "Apply FPV Controls to Object: %s Move Speed: %n Turn Speed: %n" , 'applyObjControls', "Variable", "20", "40"],
