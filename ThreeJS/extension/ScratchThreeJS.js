(function(ext) {
	...
	ext.camControls = function(controlsType, moveSteps, lookSteps){
		var message = "SETCAMERACONTROLS_"+controlsType+','+moveSteps+','+lookSteps;
		win.postMessage(message, liveURL);
	}
    ...
    var descriptor = {
        blocks: [
            ...
            ['', 'Add Camera Controles %m.CameraControls Move Speed: %n Look Speed: %n', 'camControls','First Person', "50", "2"],
