...
NEURONBLOCK.imageStack = function (Height, Width, colors, camera) {
	...
	this.removeSlice = function(direction, steps){
		...
		if(face == "F1"){
			if(direction=="Up"){
				if(this.zUpperLimit>(-119)&&this.zUpperLimit>this.zLowerLimit){
			...
			if(direction == "Up"){
				if(this.yUpperLimit>-119&&this.yUpperLimit>this.yLowerLimit){
				this.yUpperLimit = this.yUpperLimit - steps;
				}
			}if(direction == "Down"){
				if(this.yUpperLimit<119){
				this.yUpperLimit = this.yUpperLimit+steps;
				}
			}
